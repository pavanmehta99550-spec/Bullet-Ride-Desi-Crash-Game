      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <motion.div 
            ...
            className="bg-[#1A1A1A] border-2 border-[#FFD700]/30 p-8 rounded-3xl w-full max-w-md relative z-10 shadow-[0_0_100px_rgba(255,215,0,0.1)] overflow-hidden"
          >
            {/* Background Glow */}
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                <h3 className="text-3xl font-black italic uppercase text-[#FFD700]">
              ...
              <button 
                onClick={onClose} 
                className="text-zinc-500 hover:text-white bg-zinc-800/50 p-2 rounded-full transition-colors"
                id="close-auth-modal"
              >
                <X className="w-5 h-5" />
              </button>
            ...
            <form onSubmit={handleEmailAuth} className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      required
                      className="w-full bg-black/40 border border-zinc-800 p-4 pl-12 text-white rounded-2xl outline-none focus:border-[#FFD700] transition-colors font-medium"
                    />
                  </div>
                </div>
              )}
              ...
              <button 
                type="submit"
                disabled={loading}
                className="w-full py-4 bg-[#FFD700] text-black font-black uppercase italic rounded-2xl hover:bg-white transition-all shadow-[0_10px_30px_rgba(255,215,0,0.15)] flex items-center justify-center gap-2 group"
            ...
            <button 
              ...
              disabled={loading}
              className="w-full py-4 bg-white/5 border border-zinc-800 text-white font-bold rounded-2xl hover:bg-white/10 transition-all flex items-center justify-center gap-3 group"
